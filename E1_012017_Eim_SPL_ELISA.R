# E1 012017 Eim ELISA SPL cleanup and processing into clean table
library(httr)
library(RCurl)
library(Rmisc)
library(tidyr)
...
E1_std <- read.csv(text = getURL("https://raw.githubusercontent.com/derele/Jan2017Exp/master/E1_012017_Eim_SPL_ELISA1_std.csv"))
E1_samples <- read.csv(text = getURL("https://raw.githubusercontent.com/derele/Jan2017Exp/master/E1_012017_Eim_SPL_ELISA1_samples.csv"))
...
E1 <- data.frame(E1)
colnames(E1)[1] <- "IFNy_SPL"
E1 <- dplyr::select(E1, IFNy_SPL)
...
write.csv(E1, "./Jan2017Exp/E1_012017_Eim_SPL_ELISA1.csv")

E2_std <- read.csv(text = getURL("https://raw.githubusercontent.com/derele/Jan2017Exp/master/E1_012017_Eim_SPL_ELISA2_std.csv"))
...
E1 <- read.csv(text = getURL("https://raw.githubusercontent.com/derele/Jan2017Exp/master/E1_012017_Eim_SPL_ELISA1.csv"))
E1$X <- NULL
E <- rbind(E1, E2)
